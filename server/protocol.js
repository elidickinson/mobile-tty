...
// whole life, and which session a viewer is looking at is chosen by which
// socket it opens (`/ws?session=<id>`, see server/supervisor.js) rather than
// by a frame sent after connecting. `GET /places` on the supervisor replaces
// the old ASK_PLACES/PLACES round trip.
